...
public class ItemInteractController {
	...
	public boolean checkItemRC(PlayerInteractEvent e) {
		if (checkEventByPack(e, PlayerInteractConfig.ITEM_RC_EW)) {
			return true;
		} else if (checkEventByPack(e, PlayerInteractConfig.ITEM_RC_WG)) {
			return true;
		} else if (checkEventByPack(e, PlayerInteractConfig.ITEM_RC_MY)) {
			return true;
		}
		return false;
	}
	...
	public boolean checkItemLC(PlayerInteractEvent e) {
		if (checkEventByPack(e, PlayerInteractConfig.ITEM_LC_EW)) {
			return true;
		} else if (checkEventByPack(e, PlayerInteractConfig.ITEM_LC_WG)) {
			return true;
		} else if (checkEventByPack(e, PlayerInteractConfig.ITEM_LC_MY)) {
			return true;
		}
		return false;
	}
	...
	public boolean checkItem(PlayerInteractEvent e) {
		Player p = (Player) e.getPlayer();
		if (p.hasPermission(Vars.PERM_ALL_ITEMS_INTERACT))
			return false;
		ItemStack itm = e.getItem();
		if (e.getAction().equals(Action.RIGHT_CLICK_BLOCK) || e.getAction().equals(Action.LEFT_CLICK_BLOCK)) {
			...
			if (dcf.getBool(DebugConfig.PARAM_DCLICKI) && p.hasPermission(Vars.PERM_DBGCLKI)) {
